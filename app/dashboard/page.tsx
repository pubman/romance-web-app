  ...
  const userStories = [
    {
      ...
      excerpt: "Sarah never expected to find love while managing her family's struggling vineyard...",
      isPublic: false,
    ...
    },
    {
      ...
      excerpt: "In Regency London, Lady Catherine discovers that the mysterious Duke harbors a secret that could change everything...",
      isPublic: true,
  ...
  const sharedStories = [
    {
      ...
      author: "Emma Wilson",
      sharedAt: "2024-01-12",
      excerpt: "A chance encounter at the Eiffel Tower leads to an unexpected romance...",
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-card/60 backdrop-blur-sm rounded-lg p-6 border">
            ...
            <p className="text-2xl font-heading text-primary">{userStories.length}</p>
          ...
          <div className="bg-card/60 backdrop-blur-sm rounded-lg p-6 border">
            ...
            <p className="text-2xl font-heading text-primary">{sharedStories.length}</p>
            <p className="text-sm text-muted-foreground">Stories shared with you</p>
          </div>
