		...
		return (
			<div className="max-w-4xl mx-auto p-6">
				<Alert variant="destructive">
					<AlertCircle className="h-4 w-4" />
					<AlertDescription>
						Story preferences not found. Cannot retry generation.
					</AlertDescription>
				</Alert>
			</div>
		);
				...
				<div className="text-center space-y-4">
					...
					<div>
						...
						<p className="text-muted-foreground mt-2">
							Let&apos;s try generating &quot;{story.title}&quot; again with
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-sm text-green-700 dark:text-green-200">
									Failed jobs don&apos;t cost any credits. Only successful story
									generations will use your credits, so you can retry as many
									times as needed without worry.
								</p>
							</div>
						</div>
					</CardContent>
						...
						<div>
							...
							<div className="flex gap-2">
								<Badge variant="secondary">
									{preferences?.elements?.genre || "Romance"}
								</Badge>
										...
										{preferences.characters.protagonist && (
											<div className="space-y-2">
												...
												<div className="text-sm text-muted-foreground space-y-1">
													...
													{preferences.characters.protagonist.traits &&
														preferences.characters.protagonist.traits.length >
															0 && (
															<div>
										...
										{preferences.characters.love_interest && (
											<div className="space-y-2">
												...
												<div className="text-sm text-muted-foreground space-y-1">
													...
													{preferences.characters.love_interest.traits &&
														preferences.characters.love_interest.traits.length >
															0 && (
															<div>
																<strong>Traits:</strong>
																<div className="flex flex-wrap gap-1 mt-1">
