      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) => updateCharacter(type, "name", e.target.value)}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mt-2 mb-3">
            {occupations.slice(0, 8).map((occupation) => (
              <Button
                ...
                size="sm"
                onClick={() => updateCharacter(type, "occupation", occupation)}
              >
                {occupation}
              </Button>
            ))}
          ...
          <Input
            ...
            onChange={(e) => updateCharacter(type, "occupation", e.target.value)}
            ...
            {character.traits?.map((trait: string) => (
              <Badge key={trait} variant="secondary" className="flex items-center gap-1">
                ...
                <X 
                  ...
                  onClick={() => removeTrait(type, trait)}
                />
              </Badge>
            ))}
          </div>
