...
const conflictTypes = [
	{
		...
		description: "Personal struggles and growth",
	},
	{
		id: "external",
		name: "External Conflict",
		description: "Outside forces and obstacles",
	},
	{
		id: "both",
		name: "Both",
		description: "Mix of internal and external challenges",
	},
];
...
export function ElementsStep({ preferences, onUpdate }: ElementsStepProps) {
	...
	const toggleTrope = (trope: string) => {
		...
		if (currentTropes.includes(trope)) {
			updateElements(
				"tropes",
				currentTropes.filter((t: string) => t !== trope)
			);
		...
		<div className="space-y-8">
			<div>
				...
				<p className="text-sm text-muted-foreground mb-4">
					Choose up to 3 tropes you&apos;d like to include
				</p>
