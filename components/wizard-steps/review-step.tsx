    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <p className="font-medium">{getGenreName(preferences.genre)}</p>
            </div>
            <div>
              <span className="text-sm text-muted-foreground">Mood:</span>
              <p className="font-medium">{getMoodName(preferences.mood)}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div>
              <span className="text-sm text-muted-foreground">Main Character:</span>
              <p className="font-medium">{preferences.characters.protagonist.name}</p>
              <p className="text-sm text-muted-foreground">{preferences.characters.protagonist.occupation}</p>
              <div className="flex flex-wrap gap-1 mt-1">
                {preferences.characters.protagonist.traits?.map((trait: string) => (
            ...
            <div>
              <span className="text-sm text-muted-foreground">Love Interest:</span>
              <p className="font-medium">{preferences.characters.love_interest.name}</p>
              <p className="text-sm text-muted-foreground">{preferences.characters.love_interest.occupation}</p>
              <div className="flex flex-wrap gap-1 mt-1">
                {preferences.characters.love_interest.traits?.map((trait: string) => (
                  <Badge key={trait} variant="outline" className="text-xs">
                    {trait}
                  </Badge>
                ))}
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <p className="font-medium">{getTimePeriodName(preferences.setting.time_period)}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium">{getAtmosphereName(preferences.setting.atmosphere)}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <p className="font-medium">{getHeatLevelName(preferences.elements.heat_level)}</p>
            </div>
            <div>
              <span className="text-sm text-muted-foreground">Length:</span>
              <p className="font-medium">{getStoryLengthName(preferences.elements.story_length)}</p>
            </div>
            <div>
              <span className="text-sm text-muted-foreground">Conflict:</span>
              <p className="font-medium">{getConflictTypeName(preferences.elements.conflict_type)}</p>
            </div>
          </CardContent>
        </Card>
      </div>
