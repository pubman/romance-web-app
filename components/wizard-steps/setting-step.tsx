...
const atmospheres = [
	{
		id: "cozy",
		name: "Cozy & Intimate",
		description: "Warm, comfortable settings",
	},
	{
		id: "glamorous",
		name: "Glamorous",
		description: "Luxurious, sophisticated places",
	},
	{
		id: "rustic",
		name: "Rustic & Natural",
		description: "Countryside, nature settings",
	},
	{
		id: "urban",
		name: "Urban & Modern",
		description: "City life, contemporary spaces",
	},
	{
		id: "exotic",
		name: "Exotic & Adventurous",
		description: "Unique, far-off locations",
	},
	{
		id: "mysterious",
		name: "Mysterious",
		description: "Intriguing, secretive places",
	},
];
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
					{timePeriods.map((period) => (
						<Button
							key={period.id}
							variant={
								preferences?.setting?.time_period === period.id
									? "default"
									: "outline"
							}
				...
				<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 mb-4">
					{locations.map((location) => (
						<Button
							key={location}
							variant={
								preferences?.setting?.location === location
									? "default"
									: "outline"
							}
							size="sm"
