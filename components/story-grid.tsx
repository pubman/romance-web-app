...
function isLegacyStory(
	story: DatabaseStory | LegacyStory
): story is LegacyStory {
...
function convertLegacyStory(story: LegacyStory): DatabaseStory {
	return {
		...
		wizard_data: {
			characters: {
				protagonist: story.characters[0]
					? { name: story.characters[0] }
					: undefined,
				love_interest: story.characters[1]
					? { name: story.characters[1] }
					: undefined,
			},
		},
